...
export function IconWord({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
      <polyline points="14 2 14 8 20 8" />
      <path d="M10 12h1.5a1.5 1.5 0 1 0 0-3H10v6" />
    </svg>
  );
}

export function IconExcel({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
      <polyline points="14 2 14 8 20 8" />
...
export function IconArchive({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="3" width="20" height="18" rx="2" />
      <path d="M10 3v4a1 1 0 0 1-1 1H6" />
...
const FILE_TYPE_MAP = {
  image: { icon: IconImage, color: "text-blue-500", bg: "bg-blue-50", label: "Şəkil" },
  video: { icon: IconVideo, color: "text-purple-500", bg: "bg-purple-50", label: "Video" },
  pdf: { icon: IconPdf, color: "text-red-500", bg: "bg-red-50", label: "PDF" },
  word: { icon: IconWord, color: "text-blue-600", bg: "bg-blue-50", label: "Word" },
  excel: { icon: IconExcel, color: "text-green-600", bg: "bg-green-50", label: "Excel" },
  archive: { icon: IconArchive, color: "text-amber-500", bg: "bg-amber-50", label: "Arxiv" },
  other: { icon: IconFile, color: "text-slate-500", bg: "bg-slate-50", label: "Fayl" },
};

const EXT_MAP = {
  jpg: "image", jpeg: "image", png: "image", gif: "image", webp: "image", svg: "image", bmp: "image", ico: "image", tiff: "image",
